#! /bin/sh
filename="Testing" #put name of compiled file here
argv="" #put your argv parameters here
outputfile="output.out" #put name of the outputfile here
gradingfile="correct.out" #put name of file with correct output here
